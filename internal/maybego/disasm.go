...
func NewDisasm() *Disasm {
	...
	disasm.opcodes = [256]func() string{
		...
		func() string { disasm.current_addr++; return "RLCA\n" }, /* 0x07 */
		...
		func() string { disasm.current_addr++; return "RRCA\n" }, /* 0x0F */
		func() string { disasm.current_addr++; return "STOP\n" }, /* 0x10 */
		...
		func() string { disasm.current_addr++; return "RLA\n" },  /* 0x17 */
		...
		func() string { disasm.current_addr++; return "RRA\n" },  /* 0x1F */
		...
		func() string { disasm.current_addr++; return "DAA\n" },  /* 0x27 */
		...
		func() string { disasm.current_addr++; return "CPL\n" },  /* 0x2F */
		...
		func() string { disasm.current_addr++; return "SCF\n" },  /* 0x37 */
		...
		func() string { disasm.current_addr++; return "CCF\n" },  /* 0x3F */
		...
		func() string { disasm.current_addr++; return "HALT\n" }, /* 0x76 */
		...
		func() string { disasm.current_addr++; return "RET\n" },  /* 0xC9 */
		...
		func() string { disasm.current_addr++; return "RETI\n" }, /* 0xD9 */
		...
		func() string { disasm.current_addr++; return "DI\n" },   /* 0xF3 */
		...
		func() string { disasm.current_addr++; return "EI\n" },   /* 0xFB */
