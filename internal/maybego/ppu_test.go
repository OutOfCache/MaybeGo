...
func TestMode0STATInterrupt(t *testing.T) {
	var tests = []struct {
		...
		// stat set, int enabled
		{MODE3_END, 0, 0xB, 0xB, 0x0},      // mode 0, rows 0-143, ie, stat set
		{MODE3_END, 1, 0xB, 0x8, 0x2},      // mode 0, rows 0-143, ie, stat set
		{MODE3_END + 1, 0, 0xB, 0x8, 0x2},  // mode 0, rows 0-143, ie, stat set
		{MODE3_END + 1, 87, 0xB, 0xA, 0x0}, // mode 0, rows 0-143, ie, stat set
		{455, 0, 0xB, 0x8, 0x2},            // mode 0, rows 0-143, ie, stat set
		{455, 1, 0x8, 0xA, 0x0},            // mode 0, rows 0-143, ie, stat set
		// stat not enabled
		{MODE3_END, 0, 0x3, 0x3, 0x0},      // mode 0, rows 0-143, ie, stat set
		{MODE3_END, 1, 0x3, 0x0, 0x0},      // mode 0, rows 0-143, ie, stat set
		{MODE3_END + 1, 0, 0x0, 0x0, 0x0},  // mode 0, rows 0-143, ie, stat set
		{MODE3_END + 1, 87, 0x0, 0x2, 0x0}, // mode 0, rows 0-143, ie, stat set
